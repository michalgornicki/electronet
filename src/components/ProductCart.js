...
const ProductCart = props => {
    ...
    <div className="product-cart" onMouseLeave={() => document.getElementsByClassName("product-cart")[0].style.display="none"}>
          ...
          <h1 className="cart-availability">Dostępność: {props.StateData.selectedAvailability}</h1>
          <div className="cart-text">
          <h1 className="cart-description">{props.StateData.selectedDescription}</h1>
          ...
          <div className="add-to-cart-large" onClick={props.AddToBasketCart}> Do koszyka</div>
          <div><div className="cart-close" onClick={props.cartClose}>Zamknij</div></div>
