    ...
    <div>
        ...
        <div className="bar-large" alt=""> 
          <div className="bar-text bar-text-large"> 
            ...
            <div className="bar-text-2">odbierz 10% rabatu </div> 
            <div className="bar-text-3">na trzy pierwsze produkty</div>
            <div className="bar-text-3"><form className="newsletter-form" action=""><input className="newsletter-input" type="text"/><button className="newsletter-button">Zapisz się</button></form></div>
          </div> 
      </div>
