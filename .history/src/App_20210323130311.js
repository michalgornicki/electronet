...
class App extends Component {
  ...
  deleteItem = event => {
    console.log(event.target.parentElement.parentElement.getElementsByClassName("basket-item-index")[0].innerHTML)
            ...
            <div className="basket-items">
              ...
              .map(basketItem =>{
                return(
                  ...
                  <div onClick={this.deleteItem} className="deleteItem"><img className="delete-icon" src="delete.png" alt=""/></div>
                  </li>
