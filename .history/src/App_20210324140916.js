...
orderSummary = event => {
  ...
  error[0].style.innerHTML="Imię i nazwisko powinno zawierać conajmniej 6 liter"
  : 
  ...
  return (
    ...
    <div className="items-display">
      ...
      <div className="delivery-cart">
        ...
        <h1 className="delivery-form"><form action=""><input className="delivery-input" maxLength="9" type="aaa" placeholder="Telefon"/><span className="delivery-error">Wpisz prawidłowy numer telefonu (9 cyfr)</span></form></h1>
        </div>
