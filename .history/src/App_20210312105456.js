...
class App extends Component {
  ...
  return (
    ...
    <div>
        ...
        <h1 className="cartTitle">{this.state.selectedCategory}</h1>
        <h1 className="cartTitle">{this.state.selectedDescription}</h1>
        <img className="cartTitle" src={this.state.selectedPhoto} alt=""/>
