...
class App extends Component {
  ...
  return (
    ...
    <h1 className="main-header"> <a href="index.html"><div className="main-header-text">ELECTRONET</div></a> <form class="search-product" action=""> <input onClick={this.searchProduct} class="search-product-input" type="text"/><button class="search-product-button" type="submit">SZUKAJ</button></form> <div className="basket"><img className="cart-large" src="cart.png" alt=""/> ({this.state.basketItems}) {(this.state.basket).toFixed(2)} zł</div> </h1>
