  ...
  return (
    ...
    <div className="items-display">
      ...
      <div className="delivery-cart">
        ...
        <h1><div className="delivery-type"><input type="radio" name="delivery"/> Paczkomat inPost 24/7 9.99 zł</div></h1>
        <h1><div className="delivery-type"><input type="radio" name="delivery"/> Odbiór osobisty w salonie Electronet - 0 zł</div></h1>
        <h1></h1>
        </div>
