...
class App extends Component {
  ...
  return (
    ...
    <div className="items-display">
        ...
        <div className="delivery">
        <h1><div className="delivery-type"><input type="radio" name="payment"/>Kurier - InPost, UPS lub FedEx</div></h1>
        <h1><div className="delivery-type"><input type="radio" name="payment"/>Paczkomat inPost 24/7</div></h1>
        <h1><div className="delivery-type"><input type="radio" name="payment"/>Odbiór osobisty w salonie Electronet</div></h1>
        <h1></h1>
        </div>
