...
class App extends Component {
  ...
  ClickProduct = event => {
    this.setState({
      selectedProduct: event.target.parentElement.getElementsByClassName('price')[0].innerHTML,
      selectedPrice: parseFloat(event.target.parentElement.getElementsByClassName('price')[0].innerHTML),
      selectedAvailability: event.target.parentElement.getElementsByClassName('price')[0].innerHTML,
      selectedCategory:,
      selectedDescription:
    })
  }
  ...
  return (
    ...
    <div>
        ...
        <div className="item" key={data.id}>
          <img className="item-image" src={product.image} alt="" onClick={ClickProduct}/>
