...
class App extends Component {
  ...
  deleteItem = event => {
    this.setState({
      myBasket: this.state.myBasket.slice(this.state.myBasket.indexOf(event.target.parentElement.getElementsByClassName('basket-item-title').innerHTML), 1),
    })
    console.log(event.target.parentElement.getElementsByClassName('basket-item-title')[].innerHTML)
  }
            ...
            <div className="basket-items">
              ...
              .map(basketItem =>{
                return(
                  ...
                  {this.state.myBasket.indexOf(basketItem.title)}
