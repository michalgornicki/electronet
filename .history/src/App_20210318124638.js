...
class App extends Component {
  ...
  AddToBasket = event => {
    this.setState({
      ...
      myBasket: this.state.myBasket.concat ({"title": event.target.parentElement.getElementsByClassName('title')[0].innerHTML, "price": event.target.parentElement.getElementsByClassName('price')[0].innerHTML})
    });   
