  ...
  return (
    ...
    <div>
        ...
        <div className="item" key={data.id}>
          ...
          <button className="add-to-cart" onClick={this.AddToBasket}><img className="cart" src="cart.png" alt=""/>Do koszyka</button>
        </div>
        )})
        }
        </div>
        ...
        <div><button className="cartClose" onClick={this.cartClose}>Zamknij</button></div>
