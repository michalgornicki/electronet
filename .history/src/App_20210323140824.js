  ...
  return (
    ...
    <div className="items-display">
      ...
      <div className="delivery-cart">
        ...
        <h1 className="basket-value">Wartość koszyka: {(parseFloat(this.state.myBasket.reduce((acc, array) => acc + array.price, 0)) + this.state.selectedDelivery).toFixed(2)} zł</h1>
