...
orderSummary = event => {
  ...
  return (
    ...
    <button id="disk" className="button-category" onClick={this.ChooseCategory}>Dyski <img class="category-icon" src="ram.png" alt=""/></button>
    <button id="accesories" className="button-category" onClick={this.ChooseCategory}>Peryferia <img class="category-icon" src="ram.png" alt=""/></button>
    <button id="graphic" className="button-category" onClick={this.ChooseCategory}>Karty graficzne <img class="category-icon" src="ram.png" alt=""/></button>
    <button id="sound" className="button-category" onClick={this.ChooseCategory}>Dźwięk <img class="category-icon" src="ram.png" alt=""/></button>
    <button id="laptops" className="button-category" onClick={this.ChooseCategory}>Laptopy <img class="category-icon" src="ram.png" alt=""/></button>
    <button id="monitors" className="button-category" onClick={this.ChooseCategory}>Monitory <img class="category-icon" src="ram.png" alt=""/></button>
    </div>
