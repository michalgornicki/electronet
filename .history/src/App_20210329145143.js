...
orderSummary = event => {
  ...
  return (
    ...
    <DeliveryCart cartClose={this.cartClose} orderSummary={this.orderSummary} formValidation={this.formValidation} selectCourier={this.selectCourier} selectInpost={this.selectInpost} selectPickup={this.selectPickup}/>
