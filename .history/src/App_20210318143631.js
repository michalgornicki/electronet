...
class App extends Component {
  ...
  return (
    ...
    <img className="cart-large" src="cart.png" alt=""/> ({this.state.basketItems}) {parseFloat(this.state.myBasket.map(item => item.price)).reduce((prev, next) => prev + next)} zł
    </div> 
    </h1>
