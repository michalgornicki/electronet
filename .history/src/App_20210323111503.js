...
class App extends Component {
  ...
  return (
    ...
    <div className="items-display">
        ...
        <h1><input type="radio" name="delivery"/><div className="delivery-type">Kurier - InPost, UPS lub FedEx</div></h1>
        <h1><input type="radio" name="delivery"/><div className="delivery-type">Poczta Polska</div></h1>
        <h1><input type="radio" name="delivery"/><div className="delivery-type">Paczkomat inPost 24/7</div></h1>
        <h1><input type="radio" name="delivery"/><div className="delivery-type">Odbiór osobisty w salonie Electronet</div></h1>
        <h1></h1>
        </div>
