...
class App extends Component {
  ...
  ClickProduct = event => {
    ...
    this.setState({
      ...
      selectedPhoto: event.target.parentElement.getElementsByClassName('item-image')[0]
    })
  }
  ...
  return (
    ...
    <div>
        ...
        <h1>{this.state.selectedProduct}</h1>
        <h1>{this.state.selectedPrice}</h1>
        <h1>{this.state.selectedAvailability}</h1>
        <h1>{this.state.selectedProselectedCategoryduct}</h1>
        <h1>{this.state.selectedDescription}</h1>
        <img src={this.selectedPhoto} alt=""/>
        <h1></h1>
