...
class App extends Component {
  ...
  searchProduct = event => {
    document.getElementsByClassName("bar")[0].style.height="0px";
    document.getElementsByClassName("bar-small")[0].style.height="0px";
    document.getElementsByClassName("bar-small")[1].style.height="0px";
  }
