...
class App extends Component {
  ...
  return (
    ...
    <div className="items-display">
        ...
        <h1><input type="radio" name="delivery-method"/><div className="delivery-type">Poczta Polska</h1>
        <h1><input type="radio" name="delivery-method"/><div className="delivery-type">Paczkomat inPost 24/7</h1>
        <h1><input type="radio" name="delivery-method"/><div className="delivery-type">Odbiór osobisty w salonie Electronet</h1>
        <h1></h1>
        </div>
