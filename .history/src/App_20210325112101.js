...
class App extends Component {
  ...
  selectCourier = event => {
    event.target.parentElement.style.border="1px solid rgb(0, 192, 26)"
    event.target.parentElement.style.color="rgb(0, 192, 26)"
    ...
    event.target.parentElement.style.border="1px solid rgb(0, 0, 0)"
    event.target.parentElement.style.color="rgb(0, 0, 0)"
