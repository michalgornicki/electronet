...
class App extends Component {
  ...
  selectCourier = event => {
    this.setState({
      selectedDelivery: 14.99
    })
  }

    selectInpost = event => {
      this.setState({
        selectedDelivery: 9.99
      })
    }
  ...
  return (
    ...
    <div className="items-display">
      ...
      <div className="delivery-cart">
        ...
        <h1 className="basket-value">Wartość koszyka: {parseFloat(this.state.myBasket.reduce((acc, array) => acc + array.price, 0).toFixed(2)) + this.state.selectedDelivery} zł</h1>


        <h1 className="delivery-title">1. Sposób dostawy</h1>
        
        <div className="delivery">
        <h1><div className="delivery-type"><input type="radio" name="delivery" checked={this.selectCourier}/> Kurier - InPost, UPS lub FedEx - 14.99 zł</div></h1>
        <h1><div className="delivery-type"><input type="radio" name="delivery" checked={this.selectInpost}/> Paczkomat inPost 24/7 9.99 zł</div></h1>
        <h1><div className="delivery-type"><input type="radio" name="delivery" checked={this.selectPickup}/> Odbiór osobisty w salonie Electronet - 0 zł</div></h1>
        <h1></h1>
        </div>
