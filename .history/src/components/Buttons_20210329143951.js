...
const Buttons = props => {
    return(
        ...
        <button id="all" className="button-category" onClick={() => props.StateData.setState({category: "memory disk accesories graphic sound laptops monitors"})}>Wszystko <img class="category-icon" src="all.png" alt=""/></button>
