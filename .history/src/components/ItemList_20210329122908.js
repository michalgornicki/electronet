...
const ItemList = () => {
    ...
    return(
        ...
        <div className="item" key={data.id} >
          <img className="item-image" src={product.image} alt="" onClick={this.ClickProduct.bind(this)}/>
          <h1 className="title" onClick={this.ClickProduct.bind(this)}>{product.title}</h1>
