  ...
  return (
    <div className="summary-cart">
      ...
      <div className="basket-items">
        ...
        <h1 className="basket-value-summary">
          Razem do zapłaty:{" "}
          {(
            props.StateData.myBasket.reduce(
              (acc, array) => acc + array.price,
              0
      ...
      <h1 className="delivery-selection-info">
        Sposób wysyłki: {props.StateData.DeliveryType} (
        {props.StateData.DeliveryPrice} zł)
      </h1>
      ...
      <div>
        <div className="cart-close" onClick={props.backToBasket}>
          Wróć
        </div>
      </div>
