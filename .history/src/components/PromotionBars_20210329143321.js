...
const BasketCart = props => {
    return(
        ...
        <div className="bar-selector" style={{color: props.StateData.slideIndex == 1 ? "white" : "gray"}}>___</div>
        <div className="bar-selector" style={{color: props.StateData.slideIndex == 2 ? "white" : "gray"}}>___</div>
        <div className="bar-selector" style={{color: props.StateData.slideIndex == 3 ? "white" : "gray"}}>___</div>
        <div className="bar-selector" style={{color: props.StateData.slideIndex == 4 ? "white" : "gray"}}>___</div>
        <div className="bar-selector" style={{color: props.StateData.slideIndex == 5 ? "white" : "gray"}}>___</div>
        </div>
