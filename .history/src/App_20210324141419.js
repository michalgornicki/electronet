...
orderSummary = event => {
  ...
  error[2].innerHTML="Imię i nazwisko powinno zawierać conajmniej 6 liter"
  : 
  error[2].innerHTML="&#9989;";


  input[3].value.length < 4 ?
  error[3].innerHTML="Imię i nazwisko powinno zawierać conajmniej 6 liter"
  : error[3].innerHTML="&#9989;";

  input[4].value.length < 4  || !(input[4].value.includes("@")) || !(input[4].value.includes(".")) ?
  error[4].innerHTML="Imię i nazwisko powinno zawierać conajmniej 6 liter"
  : error[4].innerHTML="&#9989;";

  input[5].value.length < 9 || input[5].value.match(".*\\dst.*") ?
  eerror[0].innerHTML="Imię i nazwisko powinno zawierać conajmniej 6 liter"
  : error[5].innerHTML="&#9989;";
  ...
  return (
    ...
    <div className="items-display">
      ...
      <div className="delivery-cart">
        ...
        <div className="delivery">
        <h1 className="delivery-form"><form action=""><input className="delivery-input" type="aaa" placeholder="Imię i nazwisko"/><span className="delivery-error"></span></form> </h1> 
        <h1 className="delivery-form"><form action=""><input className="delivery-input" type="aaa" placeholder="Ulica i numer"/><span className="delivery-error"></span></form></h1>
        <h1 className="delivery-form"><form action=""><input className="delivery-input" maxLength="6" type="aaa" placeholder="Kod pocztowy"/><span className="delivery-error"></span></form></h1>
        <h1 className="delivery-form"><form action=""><input className="delivery-input" type="aaa" placeholder="Miejscowość"/><span className="delivery-error"></span></form></h1>
        <h1 className="delivery-form"><form action=""><input className="delivery-input" type="aaa" placeholder="E-mail"/><span className="delivery-error"></span></form></h1>
        <h1 className="delivery-form"><form action=""><input className="delivery-input" maxLength="9" type="aaa" placeholder="Telefon"/><span className="delivery-error"></span></form></h1>
        </div>
