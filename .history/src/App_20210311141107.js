...
class App extends Component {
  ...
  AddToBasket = event => {
    ...
    console.log(parseFloat(this.state.basket));
  }
  ...
  return (
    ...
    <h1 className="main-header"> <div className="main-header-text">ELECTRONET</div> <div className="basket">W koszyku: {this.math.round(this.state.basket)} zł</div> </h1>
