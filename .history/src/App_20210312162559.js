...
class App extends Component {
  ...
  AddToBasket = event => {
    document.getElementsByClassName("basket")[0].classList.add("basket-animation").then
document.getElementsByClassName("basket")[0].classList.remove("basket-animation");
    this.setState({
