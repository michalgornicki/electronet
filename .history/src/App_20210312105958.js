...
class App extends Component {
  ...
  ClickProduct = event => {
    document.getElementsByClassName("product-cart").style.display="block";
  ...
  return (
    ...
    <div>
        ...
        <h1 className="cartPrice">{this.state.selectedPrice}</h1>
        <h1 className="cartAvailability">{this.state.selectedAvailability}</h1>
        <h1 className="cartCategory">{this.state.selectedCategory}</h1>
        <h1 className="cartDescription">{this.state.selectedDescription}</h1>
        <img className="cartPhoto" src={this.state.selectedPhoto} alt=""/>
        <h1><button className="cartClose" onClick={this.cartClose}>Zamknij</button></h1>
