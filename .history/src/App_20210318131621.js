...
class App extends Component {
  ...
  AddToBasketCart = event => {
    this.setState({
      ...
      basketItems: this.state.basketItems + 1,
      myBasket: [...this.state.myBasket, {title: event.target.parentElement.getElementsByClassName('cartTitle')[0].innerHTML, price: event.target.parentElement.getElementsByClassName('cartTitle')[0].innerHTML}]
    });
}
