...
class App extends Component {
  ...
  AddToBasket = event => {
    this.setState({basket: math.round(this.state.basket + parseFloat(event.target.parentElement.getElementsByClassName('price')[0].innerHTML)}));
  ...
  return (
    ...
    <h1 className="main-header"> <div className="main-header-text">ELECTRONET</div> <div className="basket">W koszyku: {this.state.basket} zł</div> </h1>
