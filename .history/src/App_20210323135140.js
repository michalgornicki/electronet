  ...
  return (
    ...
    <div className="items-display">
      ...
      <div className="delivery-cart">
        ...
        <h1><div className="delivery-type"><input type="radio" name="delivery" checked={this.selectDelivery}/> Kurier - InPost, UPS lub FedEx - 0 zł</div></h1>
        <h1><div className="delivery-type"><input type="radio" name="delivery" checked={this.selectDelivery}/> Paczkomat inPost 24/7 0 zł</div></h1>
