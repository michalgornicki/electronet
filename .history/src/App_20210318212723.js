...
class App extends Component {
  ...
  AddToBasketCart = event => {
    ...
    this.setState({
      ...
      basketItems: this.state.basketItems + 1,
      myBasket: [...this.state.myBasket, {title: event.target.parentElement.getElementsByClassName('cartTitle')[0].innerHTML, price: event.target.parentElement.getElementsByClassName('cartPrice')[0].innerHTML, index: n + 1}]
    });
}
  ...
  deleteItem = event => {
    ...
    this.setState({
      myBasket: this.state.myBasket.splice(this.state.myBasket.index, 1),
    })
    console.log(this.state.myBasket)
  }
