...
class App extends Component {
  ...
  return (
    ...
    <div className="items-display">
        ...
        <h1><input type="radio" name="delivery-method"/>Poczta Polska</h1>
        <h1><input type="radio" name="delivery-method"/>Paczkomat inPost 24/7</h1>
        <h1><input type="radio" name="delivery-method"/>Odbiór osobisty w salonie Electronet</h1>
        <h1></h1>
        </div>
