...
class App extends Component {
  ...
  AddToBasketCart = event => {
    this.setState({
      basketSum: ((this.state.basketSum) + parseFloat(event.target.parentElement.parentElement.getElementsByClassName('cartPrice')[0].innerHTML)),
      basketItems: this.state.basketItems + 1,
      myBasket: [...this.state.myBasket, {
  ...
  deleteItem = event => {
    this.setState({
      myBasket: this.state.myBasket.slice(this.state.myBasket.indexOf(this.basketItem), 1),
    })
  }
            ...
            <div className="basket-items">
              ...
              .map(basketItem =>{
                return(
                  ...
                  {this.state.myBasket.indexOf(basketItem)}
