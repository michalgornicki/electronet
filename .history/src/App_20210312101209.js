...
class App extends Component {
  ...
  return (
    ...
    <h1 className="main-header"> <div className="main-header-text">ELECTRONET</div> <div className="basket">W koszyku: {this.state.basketItems} przedmiotów, {(this.state.basket).toFixed(2)} zł</div> </h1>
