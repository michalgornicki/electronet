...
class App extends Component {
  ...
  AddToBasket = event => {
    this.setState({
      ...
      myBasket: [...this.state.myBasket, {
        ...
        id: event.target.parentElement.getElementsByClassName('product-id')[0].innerHTML,
      }]
    });  
  ...
  deleteItem = event => {
    ...
    this.setState({
      myBasket: this.state.myBasket.slice(this.state.myBasket.indexOf(event.target.parentElement.getElementsByClassName('product-id')[0].innerHTML), 1),
    })
  }
            ...
            <div className="basket-items">
              ...
              .map(basketItem =>{
                return(
                  ...
                  <div className="basket-item-index"> {basketItem.id} </div>
