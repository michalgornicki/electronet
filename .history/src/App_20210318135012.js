...
class App extends Component {
  ...
  AddToBasket = event => {
    this.setState({
      ...
      myBasket: [...this.state.myBasket, {title: event.target.parentElement.getElementsByClassName('title')[0].innerHTML, price: event.target.parentElement.getElementsByClassName('price')[0].innerHTML}]
    });   
  }
        ...
        <div className="my-basket-cart">
          <h1 className="basket-title">Twój koszyk</h1>
            <div className="basket-items">
              ...
              .map(basketItem =>{
                return(
                  <li className="basket-item">{basketItem.title} <span className="basket-item-price"> {basketItem.price}</span> <span onClick={this.deleteItem} className="deleteItem">Usuń</span></li>
