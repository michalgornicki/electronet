            ...
            <div className="basket-items">
              ...
              .map(basketItem =>{
                return(
                  ...
                  <span className="basket-item-title">{basketItem.title}</span> 
                  <span className="basket-item-price"> {basketItem.price}</span> 
                  <span onClick={this.deleteItem} className="deleteItem">Usuń</span>
                  </li>
