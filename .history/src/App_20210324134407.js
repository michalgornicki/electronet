...
orderSummary = event => {
  ...
  input[1].value.length < 6 || !(input[1].value.includes("1234567890")) ?
  ...
  return (
    ...
    <div className="items-display">
      ...
      <div className="delivery-cart">
        ...
        <h1 className="delivery-form"><form action=""><input className="delivery-input" type="aaa" placeholder="Ulica i numer"/></form><span className="delivery-error">Wpisz nazwę ulicy i numer mieszkania/domu</span></h1>
