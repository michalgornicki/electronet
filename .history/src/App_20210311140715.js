...
class App extends Component {
  ...
  AddToBasket = event => {
    this.setState({basket: this.state.basket + parseFloat(event.target.parentElement.getElementsByClassName('price')[0].innerHTML)});
    console.log(parseFloat(event.target.parentElement.getElementsByClassName('price')[0].innerHTML));
  }
  ...
  return (
    ...
    <h1 className="main-header"> <div className="main-header-text">ELECTRONET</div> <div className="basket">BASKET:</div> </h1>
