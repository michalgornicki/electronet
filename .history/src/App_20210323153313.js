...
orderSummary = event => {
  ...
  return (
    ...
    <div className="bar-selector" style={{color: this.state.slideIndex == 1 ? "white" : "gray"}}>__</div>
    <div className="bar-selector" style={{color: this.state.slideIndex == 2 ? "white" : "gray"}}>__</div>
    <div className="bar-selector" style={{color: this.state.slideIndex == 3 ? "white" : "gray"}}>__</div>
    <div className="bar-selector" style={{color: this.state.slideIndex == 4 ? "white" : "gray"}}>__</div>
    <div className="bar-selector" style={{color: this.state.slideIndex == 5 ? "white" : "gray"}}>__</div>
    </div>
