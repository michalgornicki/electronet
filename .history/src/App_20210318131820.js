...
class App extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      selectedPhoto: 0,
      showBars: true,
      myBasket: [{title: "aaa", price: 500}, {title: "bbb", price: 700}],
      minPrice: 0,
      maxPrice: 3000,
      searchInput: "",
    };
        ...
        <div className="my-basket-cart">
          <h1 className="basket-title">Twój koszyk</h1>
            <div className="basket-items">
              ...
              .map(basketItem =>{
                return(
                  <li className="basket-item">{basketItem.title} <span onClick={this.deleteItem} className="deleteItem">Usuń</span></li>
