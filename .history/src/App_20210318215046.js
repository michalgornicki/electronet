...
class App extends Component {
  ...
  deleteItem = event => {
    Array.from(document.getElementsByClassName('deleteItem'))
    event.target.parentElement.style.display="none";
    this.setState({
      myBasket: this.state.myBasket.splice(this.indexOf, 1),
    })
    console.log(Array.from(document.getElementsByClassName('deleteItem')))
  }
