...
orderSummary = event => {
  ...
  return (
    ...
    <DeliveryCart StateData={this.state} cartClose={this.cartClose} orderSummary={this.orderSummary} formValidation={this.formValidation} selectCourier={this.selectCourier} selectInpost={this.selectInpost} selectPickup={this.selectPickup}/>
