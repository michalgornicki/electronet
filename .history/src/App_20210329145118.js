...
orderSummary = event => {
  ...
  return (
    ...
    <DeliveryCart cartClose={this.cartClose} orderSummary={this.orderSummary} formValidation={this.formValidation} selectCourier={this.selectCourier} selectCourier={this.selectCourier} selectCourier={this.selectCourier}/>
