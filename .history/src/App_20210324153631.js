...
orderSummary = event => {
  ...
  !(regulation.checked) ?
  error[6].innerHTML="Wpisz prawidłowy numer telefonu (9 cyfr)"
  : error[6].innerHTML="&#9989;";
  ...
  return (
    ...
    <div className="items-display">
      ...
      <div className="delivery-cart">
        ...
        <h1 className="delivery-agree"><input type="checkbox" name="" id="regulation-accept"/> Akceptuję regulamin sklepu. * <span className="delivery-error"></span></h1>
