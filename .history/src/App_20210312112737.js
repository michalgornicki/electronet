...
class App extends Component {
  ...
  cartClose = event => {
    document.getElementsByClassName("product-cart")[0].style.display="none";
  }
  ...
  return (
    ...
    <div>
        ...
        <div className="item" key={data.id}>
          <img className="item-image" src={product.image} alt="" onMouseOver={this.ClickProduct}/>
        ...
        <div className="product-cart" onMouseOut={this.cartClose}>
