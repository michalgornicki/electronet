...
function App() {
  ...
  return (
    ...
    <div className="bar" alt=""> <div className="bar-text"> <div className="bar-text-1">darmowa dostawa od 150 zł</div> </div> </div>

    <div>raty 10 x 0%</div> <div>zakupy dostępne od ręki</div>
