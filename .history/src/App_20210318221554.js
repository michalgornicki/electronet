...
class App extends Component {
  ...
  deleteItem = event => {
    ...
    this.setState({
      myBasket: this.state.myBasket.slice(this.state.myBasket.indexOf(event.target.parentElement.getElementsByClassName('basket-item-title')[0].innerHTML), 1),
    })
    console.log(event.target.parentElement.getElementsByClassName('basket-item-title')[0].innerHTML)
  }
