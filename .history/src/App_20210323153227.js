...
orderSummary = event => {
  ...
  return (
    ...
    <div className="bar-selector" style={{color: this.state.slideIndex == 2 ? "white" : "black"}}>__</div>
    <div className="bar-selector" style={{color: this.state.slideIndex == 3 ? "white" : "black"}}>__</div>
    <div className="bar-selector" style={{color: this.state.slideIndex == 4 ? "white" : "black"}}>__</div>
    <div className="bar-selector" style={{color: this.state.slideIndex == 5 ? "white" : "black"}}>__</div>
    </div>
