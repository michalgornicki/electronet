...
class App extends Component {
  ...
  return (
    ...
    <div className="bar slide" alt="" style={{display: this.state.slideIndex == 1 ? "block" : "none"}}> 
    ...
    <div className="bar slide" alt="" style={{display: this.state.slideIndex == 2 ? "block" : "none"}}> 
      <div className="bar-text"> 
        <div className="bar-text-1">darmowa dostawa od 150 zł</div> 
        <div className="bar-text-2">raty 10 x 0%</div> 
        <div className="bar-text-3">zakupy dostępne od ręki</div>
    ...
    <div className="bar slide" alt="" style={{display: this.state.slideIndex == 3 ? "block" : "none"}}> 
      <div className="bar-text"> 
        <div className="bar-text-1">darmowa dostawa od 150 zł</div> 
        <div className="bar-text-2">raty 10 x 0%</div> 
        <div className="bar-text-3">zakupy dostępne od ręki</div>
