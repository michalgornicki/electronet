  ...
  return (
    ...
    <div className="items-display">
      ...
      <div className="delivery-cart">
        ...
        <h1><div className="delivery-type"><input type="radio" name="delivery" onClick={this.selectCourier} id="ups"/> <label for="ups"> Kurier - InPost, UPS lub FedEx - 14.99 zł</label></div></h1>
