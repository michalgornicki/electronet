...
class App extends Component {
  ...
  function(a, b){
  var descending = parseFloat(a.price) - parseFloat(b.price);
  var ascending = parseFloat(b.price) - parseFloat(a.price);
  }
  ...
  return (
    ...
    <button id="ascending" className="button" onClick={this.ChooseCategory}>Od najtańszego</button>
    <button id="descending" className="button" onClick={this.ChooseCategory}>Od najtańszego</button>
