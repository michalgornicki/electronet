...
class App extends Component {
  ...
  return (
    ...
    <div className="bar-slider">
      <div className="bar slide slide-1" alt="" style={{transform: this.state.slideIndex == 1 ? "scale(1)" : "scale(0)"}}> 
      ...
      <div className="bar slide slide-2" alt="" style={{transform: this.state.slideIndex == 2 ? "scale(1)" : "scale(0)"}}> 
        <div className="bar-text"> 
          <div className="bar-text-1">Najlepsze akcesoria gamingowe</div> 
        </div> 
      </div>

      <div className="bar slide slide-3" alt="" style={{transform: this.state.slideIndex == 3 ? "scale(1)" : "scale(0)"}}> 
        <div className="bar-text"> 
          <div className="bar-text-1">Klawiatury do pracy zdalnej</div> 
        </div> 
      </div>

      <div className="bar slide slide-4" alt="" style={{transform: this.state.slideIndex == 4 ? "scale(1)" : "scale(0)"}}> 
        <div className="bar-text"> 
          <div className="bar-text-1">Profesjonalne drony już od 999 zł</div> 
        </div> 
      </div>

      <div className="bar slide slide-5" alt="" style={{transform: this.state.slideIndex == 5 ? "scale(1)" : "scale(0)"}}> 
        <div className="bar-text"> 
