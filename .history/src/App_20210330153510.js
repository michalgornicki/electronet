...
class App extends Component {
  ...
  formValidation = (event) => {
    ...
    !regulation.checked ? (error[6].innerHTML = "Zaznacz zgodę aby dokonać zakupu.") : (error[6].innerHTML = "&#9989;");
  };
    ...
    return (
      <div className="App">
        <div className="app-container">
          ...
          {this.state.currentPage == "home" ? <PromotionBars StateData={this.state} /> : ""}
          ...
          {this.state.currentPage == "summary" ? (
            <SummaryCart StateData={this.state} cartBack={this.cartBack} orderAccept={this.orderAccept} />
          ) : (
            ""
          )}
