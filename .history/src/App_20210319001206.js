...
class App extends Component {
  ...
  deleteItem = event => {
    this.setState({
      myBasket: this.state.myBasket.slice(event.target.parentElement.getElementsByClassName('basket-item-index')[0].innerHTML, 1),
    })
            ...
            <div className="basket-items">
              ...
              .map(basketItem =>{
                return(
                  ...
                  <div className="basket-item-index"> {this.state.myBasket.indexOf(basketItem)}
                  <div onClick={this.deleteItem} className="deleteItem">Usuń</div> </div>
                  </li>
