...
class App extends Component {
  ...
  return (
    ...
    <img className="cart-large" src="cart.png" alt=""/> ({this.state.basketItems}) {!this.state.myBasket == 0 ? this.state.myBasket.reduce((x, y) => x.price + y.price) : ""} zł
    </div> 
    </h1>
