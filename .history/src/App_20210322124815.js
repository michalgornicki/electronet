...
class App extends Component {
  ...
  return (
    ...
    <div className="bar slide slide-2" alt="" style={{opacity: this.state.slideIndex == 2 ? "1" : "0"}}> 
      <div className="bar-text"> 
        <div className="bar-text-1">aaa</div> 
        <div className="bar-text-2">aaa</div> 
        <div className="bar-text-3">aaa</div>
      </div> 
    </div>

    <div className="bar slide slide-3" alt="" style={{opacity: this.state.slideIndex == 3 ? "1" : "0"}}> 
      <div className="bar-text"> 
        <div className="bar-text-1">bbb</div> 
        <div className="bar-text-2">bbb</div> 
        <div className="bar-text-3">bbb</div>
      </div> 
    </div>
