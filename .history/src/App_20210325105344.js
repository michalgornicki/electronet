  ...
  return (
    ...
    <div className="items-display">
      ...
      <div className="delivery-cart">
        ...
        <h1><div className="delivery-type"><input type="radio" name="delivery" onClick={this.selectCourier} style={document.getElementsByClassName("delivery-type")[0].checked ? }/> Kurier - InPost, UPS lub FedEx - 14.99 zł</div></h1>
