  ...
  return (
    ...
    <div className="items-display">
      ...
      <div className="delivery-cart">
        ...
        <h1><div className="delivery-type"><input type="radio" name="delivery" onClick={this.selectCourier} id="ups"/> <label for="courier"> Kurier - InPost, UPS lub FedEx - 14.99 zł</label></div></h1>
        <h1><div className="delivery-type"><input type="radio" name="delivery" onClick={this.selectInpost} id="inpost"/><label for="inpost"> Paczkomat inPost 24/7 9.99 zł</label></div></h1>
        <h1><div className="delivery-type"><input type="radio" name="delivery" onClick={this.selectPickup} id="pickup"/><label for="pickup"> Odbiór osobisty w salonie Electronet - 0 zł</label></div></h1>
        </div>
