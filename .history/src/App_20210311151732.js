...
class App extends Component {
  ...
  return (
    ...
    <button id="ascending" className="button button-price" onClick={this.PriceSort}>Od najtańszego &#8593;</button>
    <button id="descending" className="button button-price" onClick={this.PriceSort}>Od najdroższego &#8595;</button>
