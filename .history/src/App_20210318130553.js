...
class App extends Component {
  ...
  AddToBasket = event => {
    this.setState({
      ...
      myBasket: this.state.myBasket.concat ({
  ...
  AddToBasketCart = event => {
    this.setState({
      ...
      basketItems: this.state.basketItems + 1,
      myBasket: [...this.myBasket, event.target.parentElement.getElementsByClassName('cartTitle')[0].innerHTML]
    });
}
        ...
        <div className="my-basket-cart">
          <h1 className="basket-title">Twój koszyk</h1>
            <div className="basket-items">
              ...
              .map(basketItem =>{
                return(
                  <li className="basket-item">{basketItem} <span onClick={this.deleteItem} className="deleteItem">Usuń</span></li>
