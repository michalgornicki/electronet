  ...
  return (
    ...
    <div className="items-display">
      ...
      <div className="delivery-cart">
        ...
        <h1><div className="delivery-type"><input type="radio" checked name="delivery" onClick={this.selectCourier}/> Kurier - InPost, UPS lub FedEx - 14.99 zł</div></h1>
        ...
        <h1 className="delivery-agree"><input type="checkbox" name="" id="regulation-accept" onChange={this.orderSummary}/> Akceptuję regulamin sklepu. * <span className="delivery-error"></span></h1>
